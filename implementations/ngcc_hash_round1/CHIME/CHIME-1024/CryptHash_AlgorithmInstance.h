...
#define ALGORITHM_INSTANCE "CHIME-1024"
...
extern "C"
{
    ...
    /*
     * Defines the sponge rate in bits for CHIME-1024.
     * 定义 CHIME-1024 的海绵速率位宽。
     */
    #define CHIME_1024_RATE_BITS   448u

    /*
     * Defines the sponge rate in bytes for CHIME-1024.
     * 定义 CHIME-1024 的海绵速率字节数。
     */
    #define CHIME_1024_RATE_BYTES   56u

    /*
     * Defines the absorb block size in bytes for CHIME-1024.
     * 定义 CHIME-1024 的吸收块字节数。
     */
    #define CHIME_1024_BLOCK_BYTES  64u

    /*
     * Defines the output digest size in bytes for CHIME-1024.
     * 定义 CHIME-1024 的摘要输出字节数。
     */
    #define CHIME_1024_DIGEST_BYTES 128u
