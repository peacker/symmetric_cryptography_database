...
int main()
{
    ...
    int rt = KAT_SUCCESS;
    start_time = clock();
    /* addtional total time calculation for every kat*/
    double t_2_12, t_2_23, t_2_33, t_loop;
    ...
    clock_t e1 = clock();
    t_2_12 = (double)(e1 - s1) / CLOCKS_PER_SEC;
    ...
    clock_t e2 = clock(); 
    t_2_23 = (double)(e2 - s2) / CLOCKS_PER_SEC;
    ...
    clock_t e3 = clock(); 
    t_2_33 = (double)(e3 - s3) / CLOCKS_PER_SEC;
    ...
    clock_t e4 = clock(); 
    t_loop = (double)(e4 - s4) / CLOCKS_PER_SEC;

    end_time = clock();
    time_elapsed = (double)(end_time - start_time) / CLOCKS_PER_SEC;
    progress_bar(4, "");
    printf("\nKAT_2_12 time: %.3f s\n", t_2_12); 
    printf("KAT_2_23 time: %.3f s\n", t_2_23); 
    printf("KAT_2_33 time: %.3f s\n", t_2_33); 
    printf("KAT_Loop time: %.3f s\n", t_loop);
