...
/* Function: main. KAT driver entry point that generates all required known-answer test-vector files for the configured AXIS instance. */
...
/* Function: validate_algorithm_instance_name. Checks that the algorithm instance name is safe to use as part of generated KAT file names. */
...
/* Function: create_directory. Creates an output directory when it is absent and treats an existing directory as success. */
...
/* Function: progress_bar. Prints the command-line progress indicator used by the KAT generation driver. */
...
/* Function: fprint_message_full. Writes a complete KAT message field to the output file in hexadecimal form. */
...
/* Function: fprint_message_partial. Writes a compact KAT message field for very large generated messages using the seed description. */
...
/* Function: fprint_digest. Writes the digest length and digest value fields to a KAT output file. */
...
/* Function: gen_KAT_2_12. Generates KAT vectors for every message length from 0 through 2^12 bits. */
...
/* Function: gen_KAT_2_23. Generates the required KAT vectors for 2^23-bit messages. */
...
/* Function: gen_KAT_2_33. Generates the required KAT vectors for 2^33-bit messages without materializing the full file text. */
...
/* Function: gen_KAT_Loop. Runs the required 2^13-bit loop test and writes the final loop digest. */
