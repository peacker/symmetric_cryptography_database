...
TYPE_MAP = {
    ...
    "oryx":                         "stream_cipher",
    "parity-check des/triple-des variants": "block_cipher",
    "paterson trapdoor cipher":     "block_cipher",
    "pea":                          "block_cipher",
    "photon":                       "permutation",
    "photon-beetle":                "aead",
    "picaro":                       "block_cipher",
    ...
    "subterranean":                 "stream_cipher+hash",
    "sundae-gift":                  "aead",
    "sycon":                        "permutation",
    "tea":                          "block_cipher",
...
NEW_ENTRIES = [
    ...
    ("[x]", "BEA-1",                    "BEA-1",                "block_cipher",         "2017", "https://arxiv.org/abs/1702.06475", "Full", "2017-bea1"),
    ...
    ("[x]", "Parity-check DES/Triple-DES variants", "Parity-check DES/Triple-DES variants", "block_cipher", "2013", "https://doi.org/10.55630/sjc.2013.7.257-270", "Full", "2013-parity-check-des-like"),
    ("[x]", "Paterson trapdoor cipher", "Paterson trapdoor cipher", "block_cipher", "1999", "https://doi.org/10.1007/3-540-48519-8_15", "Full", "1999-paterson-trapdoor-cipher"),
    ("[x]", "RadioGatún",                "RadioGatún",            "hash+stream_cipher",   "2006", "https://radiogatun.noekeon.org/RadioGatun.pdf", "Full", "2006-radiogatun"),
    ("[x]", "Raiden",                   "Raiden",               "block_cipher",         "2008", "https://doi.org/10.3233/KES-2008-12102", "Full", "2008-raiden"),
    ("[x]", "GASCON",                   "GASCON",               "permutation",          "2019", "https://csrc.nist.gov/CSRC/media/Projects/Lightweight-Cryptography/documents/round-1/spec-doc/DryGASCON-spec.pdf", "Full", "2019-drygascon"),
