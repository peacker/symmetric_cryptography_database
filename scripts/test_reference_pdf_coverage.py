...
KNOWN_MISSING = {
    ...
    "megascon_hash", "mofang_hash", "mozi_hash", "neulaser",
    ...
    "cmea", "crunch", "crypton", "cubehash",
    "dch", "deal", "dynamic_sha",
    "dynamic_sha2", "echo_hash", "ecoh", "edon_r", "enrupt", "espresso",
    "essence",
    ...
    "sarmal", "sgail", "shabal",
    "shamata", "shavite3", "simd_hash", "simeck", "siphash",
    "spectral_hash",
