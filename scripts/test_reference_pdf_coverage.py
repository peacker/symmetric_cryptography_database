...
KNOWN_MISSING = {
    "abacus", "aes", "aes_cbc", "aes_ctr", "anemoi", "aria", "arirang", "aurora",
    "blender",
    "blue_midnight_wish", "boole", "catfish", "cheetah", "chi_hash",
    "ciminion", "cmea", "crunch", "crypton", "cryptodarkmatter", "cubehash",
    "dch", "deal", "dynamic_sha",
    "dynamic_sha2", "echo_hash", "ecoh", "edon_r", "enrupt", "essence",
    "fantomas_robin", "fsb", "fugue", "griffin", "hamsi", "hmac_sha256", "hpc",
    "hydra",
    "khichidi_1",
    ...
    "pedersen_hash_zcash", "picaro",
    "polyval", "pufferfish", "rc4plus", "reinforced_concrete", "sandstorm",
    "sarmal", "sgail", "shabal",
    "shamata", "shavite3", "simd_hash", "simeck", "sinsemilla", "siphash",
    "spectral_hash",
